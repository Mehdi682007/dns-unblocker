...
# GitHub: https://github.com/Mehdi682007/dns-unblocker
# Author: Mehdi682007
...
install_dnsmasq(){
    ...
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/Mehdi682007/dns-unblocker/refs/heads/main/proxy-domains.txt
...
install_sniproxy(){
    ...
    if check_sys packageManager yum; then
        if [[ ${fastmode} = "1" ]]; then
            if [[ ${bit} = "x86_64" ]]; then
                download /tmp/sniproxy-0.6.1-1.el8.x86_64.rpm https://github.com/Mehdi682007/dns-unblocker/raw/refs/heads/main/sniproxy/sniproxy-0.6.1-1.el8.x86_64.rpm
        ...
        if centosversion 6; then
            ...
            download /etc/systemd/system/sniproxy.service https://raw.githubusercontent.com/Mehdi682007/dns-unblocker/refs/heads/main/sniproxy.service
    ...
    download /etc/sniproxy.conf https://raw.githubusercontent.com/Mehdi682007/dns-unblocker/refs/heads/main/sniproxy.conf
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/Mehdi682007/dns-unblocker/refs/heads/main/proxy-domains.txt
